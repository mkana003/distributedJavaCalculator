...
import PrimerIntento.Middleware;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					obj = (Middleware)Naming.lookup("//" + "localhost:1200" + "/ServerRMI");
					obj.GetClientIP();
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (selected != -1) {
			if (calculation.contains("-")) {
				try {
					...
					textArea_1.setText("Resta enviada el servidor");
					minus = obj.Resta(x, y);
					textArea.setText("" + minus);
					textArea_1.append("\n" + minus);
					textArea_1.append("\nResultado de la resta recibido del Servidor");
				...
				try {
					...
					x = Integer.parseInt(numbers[0]);
					y = Integer.parseInt(numbers[1]);
					textArea_1.setText("Suma enviada el servidor");
					add = obj.Suma(x, y);
					textArea.setText("" + add);
					textArea_1.append("\nResultado de la suma recibido del Servidor");
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
				...
				try {
					...
					x = Integer.parseInt(numbers[0]);
					y = Integer.parseInt(numbers[1]);
					textArea_1.setText("Multiplicacion enviada el servidor");
					multiply = obj.Mult(x, y);
					textArea.setText("" + multiply);
					textArea_1.append("\nResultado de la multipliacion recibido del Servidor");
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
					...
					try {
						...
						x = Integer.parseInt(numbers[0]);
						y = Integer.parseInt(numbers[1]);
						textArea_1.setText("Division enviada el servidor");
						division = obj.Div(x, y);
						textArea.setText("" + division);
						textArea_1.append("\nResultado de la division recibido del Servidor");
					} catch (RemoteException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
